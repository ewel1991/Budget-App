    ...
    <div class="me-auto vol-lg-8 rounded-4">
      <div class="text-overlay rounded-4 shadow">
        <div class="p-5 pb-4 border-bottom-0">
          ...
          <button type="button" class="btn-close custom-close" onclick="window.location.href='logout.php'" aria-label="Close"></button>
        </div>
        ...
        <div class="p-5 pt-0">
          <form action = "data.php" method="post">
            ...
            <div class="form-floating mb-3">
              <input type="email" name ="emailLogin" class="form-control rounded-3" id="floatingInput" placeholder="name@example.com" required>
            ...
            <div class="form-floating mb-3">
              <input type="password" name ="passwordLogin" class="form-control rounded-3" id="floatingPassword" placeholder="Password" required>
            ...
            <button class="w-100 py-3 mb-2 btn btn-brown rounded-3" type="submit" name="submitLogin">Zaloguj się</button>
